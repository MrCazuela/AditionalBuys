...
#define SHIELD "escudo tactico" //tactical shield
#define HEALTH "inyeccion" //healthshot
#define TAGRENADE "granada tactica" //tactical grenade
...
public Action CMD_BuyShield(int client, int args)
{
	...
	SetEntProp(client, Prop_Send, "m_iAccount", account - ShieldPrice);
...
{	
	...
	TPrintToChat(client, PREFIX, "object_bought", HEALTH);
...
public Action CMD_BuyTagrenade(int client, int args) 
{
	...
	TPrintToChat(client, PREFIX, "object_bought", TAGRENADE);
